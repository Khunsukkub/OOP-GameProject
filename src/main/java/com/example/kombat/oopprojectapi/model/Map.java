...
public class Map {
    ...
    @Setter
    public static Hex[][] map;
    private static int row = Hex.totalInRow;
    private static int col = Hex.totalInCol;
    public static Player[] players = new Player[2];
    public static Player current_player;

    int[] init_player1Area = {0,1,2,8,9};
    int[] init_player2Area = {54,55,61,62,63};
    int[] total_init_playerArea = {0,1,2,8,9,54,55,61,62,63};
